# TODO simulates the movement of selfish ponies and returns a dictionary
""" three arguments, all ponies list have s, each key is a timestep,0,1,2"""
""" values are list of pony tuples at that timestep"""


# check if pony reaches destination
# check if the energy difference is enough
# the smallest pony id = 0 largest = len(ponies) - 1
